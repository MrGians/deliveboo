                        ...
                        <div class="text-center">
                            ...
                            <div class="card-body">
                                <ul class="information-restaurant">
                                    <li class="title-restaurant-card">
                                        Nome Ristorante
                                    </li>
                                    <li class="category">
                                    ...
                                    <li class="address">
                                        Via delle Belle Arti 2a, Bologna, 40162
                                    </li>
                                    <li class="option">
                                        Consegna gratis | Oridne minimo 10€
                                    </li>
                ...
                <div class="col-md-12">
                    <div class="card rounded-5 mb-3 pb-5 shadow">
                        <div class="row restaurant_dishes">
                            <div class="col-3">
                                <img
                                    src="storage/products_image/placeholder.png"
                                    alt=""
                                    class="restaurant_dishes_img"
                                />
                            </div>
                            <div class="col-6">
                                <ul class="information-dishes">
                                    <li class="name_dishes">Nome piatto</li>
                                    <li class="category-dishes">
                                        Categoria 1 - Categoria 2
                                    </li>
                                    <li class="description-dishes">
                                        Lorem ipsum, dolor sit amet consectetur
                                        adipisicing elit. Sit error commodi
                                        omnis! Minus quae molestias
                                    </li>
                                    <li class="allergens-dishes">
